...
START_MESSAGE = '''**Hello, {}
I Am Tajlink.com, Bulk Link Converter. I Can Convert Links Directly From Your ShortnerFly Account,
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of Tajlink than **contact** at 👉 @technicaltaj (all **shortners** support available.)
'''

HELP_MESSAGE = '''**Hello, {}
I Am Tajlink, Bulk Link Converter Bot. I Can Convert Links Directly From Your Tajlink Account,**
...
ABOUT_TEXT = '''**Hey! My name is @TajlinkConvertor_Bot. I am Shortener TajLink Converter Bot.**
...
• **No** need to share **password or email** to convert links.**
 ...
 Anyone who want to use any **other shortner** instead of Tajlink than **contact** at 👉 @technicaltaj (all **shortners support** available.)
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://tajlink/ref/technicaltaj)
...
Get API From [{base_site}](https://tajlink/ref/technicaltaj)
...
**example:**
/channel @tajlinkofficial
Or
/channel https://t.me/tajlinkofficial 

**🤘 Hit** 👉 /features To Know More Features Of This Bot.

**- Message @technicaltaj For More Help -**"""
