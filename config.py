...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6154129452:AAHrfphvTJSS1gnyzlVl08x1n9oPEoHEPto")
...
DATABASE_URL = os.getenv("DATABASE_URL", "mongodb+srv://khantajuddeen26:<tajshort>@cluster0.kikl3jv.mongodb.net/?retryWrites=true&w=majority") 
OWNER_ID =  int(os.environ.get("OWNER_ID", "1030188110")) 
ADMINS.append(OWNER_ID) if OWNER_ID not in ADMINS else []
ADMINS.append(Id Owned Id)
#  Optionnal variables
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001944388469")) 
UPDATE_CHANNEL = os.environ.get("UPDATE_CHANNEL", "ajlinkofficial") # For Force Subscription
